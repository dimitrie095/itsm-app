...
import { LogIn, Loader2, Shield, User, Crown, Headphones, Monitor, ChevronRight, Key, Lock, Mail, Sparkles } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-slate-950 to-slate-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 p-12 flex-col justify-between bg-gradient-to-br from-slate-900 to-slate-950 border-r border-slate-800">
          ...
          <Card className="border-slate-800 bg-slate-900/80 backdrop-blur-sm shadow-2xl">
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-11 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-medium"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
                  ...
                  {demoUsers.map((user) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isLoading}
                        className="group p-4 rounded-xl bg-slate-800/30 border border-slate-700 hover:border-slate-600 hover:bg-slate-800/50 transition-all duration-200 text-left"
                      >
